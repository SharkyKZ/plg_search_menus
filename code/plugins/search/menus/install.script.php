 ...
 */
final class PlgSearchMenusInstallerScript
{
	/**
	...
	public function preflight($type, $parent)
	{
		...
		{
			Log::add(Text::sprintf('PLG_SEARCH_MENUS_INSTALL_PHP_MINIMUM', $this->phpMinimum), Log::WARNING, 'jerror');
		...
		{
			Log::add(Text::sprintf('PLG_SEARCH_MENUS_INSTALL_PHP_UNSUPPORTED', $this->phpUnsupported), Log::WARNING, 'jerror');
