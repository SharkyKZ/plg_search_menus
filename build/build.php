...
{
	private const PLUGIN_ELEMENT = 'menus';
	private const PLUGIN_TYPE = 'search';
	...
	private const UPDATE_NAME = 'Search - Menu Items';
	private const UPDATE_DESCRIPTION = 'Plugin for searching menu items in frontend.';
